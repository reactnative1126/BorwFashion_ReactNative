...
import { Modal, ListItem, Image, withTheme, SearchBar, Icon } from 'src/components';
...
class InputMobile extends Component {
  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: backgroundColor ? backgroundColor : colors.gray_modal }}>
        <ViewLabel label={label} error={error} isHeading>
          <PhoneInput
            ...
            textProps={{
              placeholder,
              placeholderTextColor: colors.unSelIcon,
              ...textProps,
            }}
