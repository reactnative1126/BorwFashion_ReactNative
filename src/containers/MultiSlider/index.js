...
class MultiSlider extends React.Component {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      let positionOne = valueToPosition(nextProps.values[0], this.optionsArray, nextProps.sliderLength);
      nextState.valueOne = nextProps.values[0];
      nextState.pastOne = positionOne;
      nextState.positionOne = positionOne;

      let positionTwo = valueToPosition(nextProps.values[1], this.optionsArray, nextProps.sliderLength);
  ...
  moveOne = gestureState => {
    ...
    if (Math.abs(accumDistanceDisplacement) < slipDisplacement || !slipDisplacement) {
      let value = positionToValue(confined, this.optionsArray, this.props.sliderLength);
      let snapped = valueToPosition(value, this.optionsArray, this.props.sliderLength);
      this.setState({
