...
export const text_color = '#676767';
export const button_color = '#0116a5';
export const text_input_border_color = '#DEDEDE';
export const action_background = '#f5d442'
export const background_comment = '#EEE'
export const yellow_invite = '#C1A01E'
export const background_bubble = '#666'
export const red_icon_ban = '#cf2a27'
export const gray_icon_ban = '#666'
export const borderAvt = '#84FFFD'
export const unSelIcon = '#999'
export const selIcon = '#84FFFD'
export const gray_modal = '#333'
