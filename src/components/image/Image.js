...
import { Animated, Image as RNImage, Platform, StyleSheet, View, TouchableOpacity } from 'react-native';
...
class Image extends React.PureComponent {
  ...
  render() {
    const { placeholderStyle, PlaceholderContent, onPress, 
      containerStyle, style, ImageComponent, ...attributes } = this.props;
