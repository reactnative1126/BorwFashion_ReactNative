...
const initConfigs = {
  ...
  toggleCheckout: true,
  facebook: 'https://www.facebook.com/', //default link
  instagram: 'https://www.instagram.com/',
  twitter: 'https://twitter.com/OfficialBorw?s=03',
  blog: 'https://www.borw.app/blog',
  linkedin: 'https://www.linkedin.com/company/borώ',
  youtube: 'https://www.youtube.com/channel/UCoEb6-gmYl-7V0MXotFJLIQ',
  phone: '0123 456 789',
...
function commonReducer(state = initState, action = {}) {
  ...
  switch (type) {
    ...
    case Actions.FETCH_SETTING_SUCCESS:
      ...
      // Override URLs from config fetch from server
      payload.configs.facebook = 'https://www.facebook.com/Borώ-102644944633662';
      payload.configs.instagram = 'https://www.instagram.com/borw2021/';
      payload.configs.twitter = 'https://twitter.com/OfficialBorw?s=03';
