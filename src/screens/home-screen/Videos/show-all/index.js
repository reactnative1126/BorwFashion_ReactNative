...
export default function ShowAllVideos({ screenProps, navigation }) {
  const { t } = screenProps;
  const { loading, videos, user, isLoading, _onLikeItem, _onBookmark, _onLoadMore } = useDesignersFacade(t);
  ...
  return (
    <ThemedView isFullView>
      ...
      <Header
        ...
        centerComponent={<TextHeader titleStyle={{ color: colors.unSelIcon }} title={t('home:text_videos')} />}
      />
