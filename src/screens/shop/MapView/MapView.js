    ...
    <View style={[styles.container, style]}>
      ...
      <View style={styles.containerOption}>
        <TouchableOpacity style={styles.item} onPress={() => _onGetCurrentLocation()}>
          ...
          <Text h5 style={{ flexShrink: 1, color: colors.grey5 }}>{t('map:text_get_my_location')}</Text>
        </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.item} onPress={_onChangeVisible}>
            ...
            <Text h5 style={{ flexShrink: 1, color: colors.grey5 }}>{t('map:text_pick_on_map')}</Text>
          </TouchableOpacity>
      </View>
