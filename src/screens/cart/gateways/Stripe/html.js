...
<head>
    ...
    <script>
      INJECT_DATA
      let stripe = Stripe(window.PUBLISHABLE_KEY || 'pk_test_6pRNASCoBOKtIshFeQd4XMUh');
      function registerElements(elements, exampleName) {
        ...
        form.addEventListener('submit', function(e) {
          ...
          let zip = form.querySelector('#' + exampleName + '-zip');
          let additionalData = {
...
<script>
  (function() {
    ...
    let theme_type = window.THEME_TYPE || 'light';
